...
void OLED::showNoMqtt()
{
    this->printTitle("MQTT", 1);
}

void OLED::showNoWlan()
{
...
void OLED::showWorking()
{
    ...
    oled.setFontType(1);
    oled.setCursor(0, 0);
    oled.print(String(seconds) + "s");
    oled.setCursor(0, 12);
    oled.print(String(minutes) + "m");
    oled.setCursor(0, 24);
    ...
    if (barheight >= oled.getLCDHeight() || barheight <= 0) {
        barDirection = !barDirection;
    } 
    
    oled.rectFill(oled.getLCDWidth() - 10, 0, 10, barheight);
